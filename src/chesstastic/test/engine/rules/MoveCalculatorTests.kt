...
class MoveCalculatorTests: ChessTestSuite() {
    init {
        describe("legalMoves") {
            it("should contain pawn promotion moves") {
        ...
        describe("isSquareAttacked") {
            it("should detect pawn attacks") {
                ...
                val pawnCalculator = PawnMoveCalculator(Pawn(Color.Light), Square(D, _7), board)

                (square in pawnCalculator.attackingSquares).shouldBe(true)
